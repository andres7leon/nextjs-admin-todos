  ...
  return (
    ...
    <div>
      ...
      <div className="mt-8 text-center">
        {/* Next/Image */}
        <Image src="https://tailus.io/sources/blocks/stats-cards/preview/images/second_user.webp" width={30} height={30} alt="" className="w-10 h-10 m-auto rounded-full object-cover lg:w-28 lg:h-28"/>
